...
public class ScddGoodsExample {
    ...
    public ScddGoodsExample() {
        oredCriteria = new ArrayList<Criteria>();
    }
    
    public ScddGoodsExample(String aliasTable) {
        oredCriteria = new ArrayList<Criteria>();
        ScddGoodsExample.aliasTable = aliasTable;
    }
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addCriterion(String condition) {
            ...
            criteria.add(new Criterion(aliasTable + "." + condition));
        }
        ...
        protected void addCriterion(String condition, Object value, String property) {
            ...
            criteria.add(new Criterion(aliasTable + "." + condition, value));
        }
        ...
        protected void addCriterion(String condition, Object value1, Object value2, String property) {
            ...
            criteria.add(new Criterion(aliasTable + "." + condition, value1, value2));
        }
